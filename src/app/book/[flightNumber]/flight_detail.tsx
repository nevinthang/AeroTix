...
import { Plane, Calendar, Clock, Plus, Trash2, CreditCard, AlertCircle, Loader2 } from "lucide-react"
...
const FlightBookingDetail: React.FC<FlightBookingDetailProps> = ({ flight }) => {
      ...
      passengers: [
        {
          ...
          dateOfBirth: user?.birthdate ? format(user.birthdate, "yyyy-MM-dd") : "",
          nationality: "United States",
          passportNumber: user?.passport || "",
          passportExpiryDate: user?.passport_exp ? format(user.passport_exp, "yyyy-MM-dd") : "",
          ageCategory: "ADULT",
          checkedBaggage: 0,
          cabinBaggage: 0,
  ...
  const onSubmit = async (data: BookingForm) => {
    try {
      ...
      if (flight.availableSeats < data.passengers.length) {
        toast.error(`Sorry, only ${flight.availableSeats} seats are available for this flight.`)
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-8">
      <motion.div
        ...
        className="mb-8"
      >
        <h1 className="text-3xl font-bold text-indigo-900 mb-2">Complete Your Booking</h1>
        <p className="text-gray-600">Please fill in the required information to book your flight.</p>
      </motion.div>
            ...
            <div className="flex flex-col md:flex-row md:items-center md:justify-between">
              <div>
                <div className="flex items-center">
                  ...
                  <h2 className="text-xl font-semibold">Flight {flight.flightNumber}</h2>
                </div>
              ...
              <div className="flex-1">
                <div className="flex items-center justify-between md:justify-start md:space-x-12">
                  <div className="text-center">
                    <p className="text-sm text-gray-500">{format(flight.departureHour, "h:mm a")}</p>
                    <h3 className="text-2xl font-bold text-indigo-900">{flight.departureCode}</h3>
                  ...
                  <div className="text-center">
                    <p className="text-sm text-gray-500">{format(flight.arrivalHour, "h:mm a")}</p>
                    <h3 className="text-2xl font-bold text-indigo-900">{flight.arrivalCode}</h3>
              ...
              <div className="mt-4 md:mt-0 md:ml-6 p-4 bg-indigo-50 rounded-lg">
                <div className="grid grid-cols-2 gap-4 text-sm">
                  ...
                  <div>
                    ...
                    <p className="font-medium text-indigo-700">${flight.price.toFixed(2)}</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          >
            <Card className="border-indigo-100 shadow-md">
              <CardHeader className="bg-gradient-to-r from-indigo-50 to-purple-50">
                ...
                <CardDescription>Please provide accurate information for all passengers</CardDescription>
              </CardHeader>
              ...
              <CardContent className="p-0">
                <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
                          ...
                          {index > 0 && (
                            <button
                              ...
                              onClick={(e) => {
                                e.stopPropagation()
                                remove(index)
                                setActiveTab(`passenger-${Math.max(0, index - 1)}`)
                              }}
                            >
                  ...
                  {fields.map((field, index) => (
                    <TabsContent key={field.id} value={`passenger-${index}`} className="p-6 space-y-6">
                        ...
                        >
                          ...
                          <div className="space-y-4">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                                ...
                                <Controller
                                  ...
                                  render={({ field }) => (
                                    <Select onValueChange={field.onChange} defaultValue={field.value}>
                                      <SelectTrigger
                                        id={`title-${index}`}
                                        className={errors.passengers?.[index]?.title ? "border-red-500" : ""}
                                      >
                                ...
                                <Controller
                                  ...
                                  render={({ field }) => (
                                    <Input
                                      id={`firstName-${index}`}
                                      {...field}
                                      className={errors.passengers?.[index]?.firstName ? "border-red-500" : ""}
                                    />
                                  )}
                                />
                                ...
                                <Controller
                                  ...
                                  render={({ field }) => (
                                    <Input
                                      id={`lastName-${index}`}
                                      {...field}
                                      className={errors.passengers?.[index]?.lastName ? "border-red-500" : ""}
                                    />
                                  )}
                                />
                                ...
                                <Controller
                                  ...
                                  render={({ field }) => (
                                    <Input
                                      ...
                                      type="date"
                                      {...field}
                                      className={errors.passengers?.[index]?.dateOfBirth ? "border-red-500" : ""}
                                    />
                                  )}
                                />
                                ...
                                <Controller
                                  ...
                                  render={({ field }) => (
                                    <Input
                                      ...
                                      {...field}
                                      className={errors.passengers?.[index]?.nationality ? "border-red-500" : ""}
                                    />
                                  )}
                                />
                              ...
                              <div className="space-y-2">
                                <Label htmlFor={`ageCategory-${index}`}>Age Category</Label>
                                <Controller
                                  control={control}
                                  name={`passengers.${index}.ageCategory`}
                                  render={({ field }) => (
                                    <Select onValueChange={field.onChange} defaultValue={field.value}>
                                      <SelectTrigger id={`ageCategory-${index}`}>
                          ...
                          <div className="mt-8 space-y-4">
                            <div className="flex items-center mb-2">
                              <h3 className="text-lg font-medium text-indigo-900">Travel Document</h3>
                              <div className="ml-2 text-xs bg-indigo-100 text-indigo-800 px-2 py-0.5 rounded-full">
                                Required
                              </div>
                            </div>
                                ...
                                <Controller
                                  ...
                                  render={({ field }) => (
                                    <Input
                                      ...
                                      {...field}
                                      className={errors.passengers?.[index]?.passportNumber ? "border-red-500" : ""}
                                    />
                                  )}
                                />
                                ...
                                <Controller
                                  ...
                                  render={({ field }) => (
                                    <Input
                                      ...
                                      type="date"
                                      {...field}
                                      className={errors.passengers?.[index]?.passportExpiryDate ? "border-red-500" : ""}
                                    />
                                  )}
                                />
                          ...
                          {/* Travel Preferences */}
                          <div className="mt-8 space-y-4">
                            <h3 className="text-lg font-medium text-indigo-900">Travel Preferences</h3>

                            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                              <div className="space-y-2">
                                <Label htmlFor={`checkedBaggage-${index}`}>Checked Baggage</Label>
                                <Controller
                                  control={control}
                                  ...
                                  render={({ field }) => (
                                    ...
                                    >
                                      <SelectTrigger id={`checkedBaggage-${index}`}>
                                        <SelectValue placeholder="Select baggage" />
                                      </SelectTrigger>
                                      <SelectContent>
                                        <SelectItem value="0">None</SelectItem>
                                        <SelectItem value="1">1 bag (+${PRICES.CHECKED_BAGGAGE})</SelectItem>
                                        <SelectItem value="2">2 bags (+${PRICES.CHECKED_BAGGAGE * 2})</SelectItem>
                                        <SelectItem value="3">3 bags (+${PRICES.CHECKED_BAGGAGE * 3})</SelectItem>
                                      </SelectContent>
                                    </Select>
                                  )}
                                />
                              ...
                              <div className="space-y-2">
                                <Label htmlFor={`cabinBaggage-${index}`}>Cabin Baggage</Label>
                                <Controller
                                  control={control}
                                  ...
                                  render={({ field }) => (
                                    <Select
                                      ...
                                      defaultValue={field.value.toString()}
                                    >
                                      <SelectTrigger id={`cabinBaggage-${index}`}>
                                        <SelectValue placeholder="Select baggage" />
                                      </SelectTrigger>
                                      <SelectContent>
                                        <SelectItem value="0">None</SelectItem>
                                        <SelectItem value="1">1 bag (+${PRICES.CABIN_BAGGAGE})</SelectItem>
                                        <SelectItem value="2">2 bags (+${PRICES.CABIN_BAGGAGE * 2})</SelectItem>
                                      </SelectContent>
                                    </Select>
                                  )}
                                />
                              ...
                              <div className="space-y-2">
                                ...
                                <Controller
                                  ...
                                  render={({ field }) => (
                                    <Select onValueChange={field.onChange} defaultValue={field.value}>
                                      <SelectTrigger id={`seatPreference-${index}`}>
                              ...
                              <div className="space-y-2">
                                ...
                                <Controller
                                  ...
                                  render={({ field }) => (
                                    <Select onValueChange={field.onChange} defaultValue={field.value}>
                                      <SelectTrigger id={`mealPreference-${index}`}>
                          ...
                          {/* Special Assistance */}
                          <div className="mt-8 space-y-4">
                            <h3 className="text-lg font-medium text-indigo-900">Special Assistance</h3>
                          ...
                          <div className="mt-8 space-y-4">
                            <div className="flex items-center mb-2">
                              <h3 className="text-lg font-medium text-indigo-900">Emergency Contact & Insurance</h3>
                              <div className="ml-2 text-xs bg-indigo-100 text-indigo-800 px-2 py-0.5 rounded-full">
                                Required
                              </div>
                            </div>
                                ...
                                <Controller
                                  ...
                                  render={({ field }) => (
                                    <Input
                                      ...
                                      {...field}
                                      className={
                                        errors.passengers?.[index]?.emergencyContactName ? "border-red-500" : ""
                                      }
                                    />
                                  )}
                                />
                                {errors.passengers?.[index]?.emergencyContactName && (
                                  <p className="text-xs text-red-500 mt-1">
                                    {errors.passengers[index]?.emergencyContactName?.message}
                                  </p>
                                )}
                              </div>

                              <div className="space-y-2">
                                <Label htmlFor={`emergencyContactPhone-${index}`}>
                                ...
                                <Controller
                                  ...
                                  render={({ field }) => (
                                    <Input
                                      ...
                                      {...field}
                                      className={
                                        errors.passengers?.[index]?.emergencyContactPhone ? "border-red-500" : ""
                                      }
                                    />
                                  )}
                                />
                                {errors.passengers?.[index]?.emergencyContactPhone && (
                                  <p className="text-xs text-red-500 mt-1">
                                    {errors.passengers[index]?.emergencyContactPhone?.message}
                                  </p>
                                )}
                              </div>
                            </div>
                              ...
                              <div className="flex items-start space-x-3">
                                ...
                                <div>
                                  ...
                                  <p className="text-xs text-gray-600 mt-1">
                                    Covers trip cancellation, medical emergencies, baggage loss and more
                                  </p>
                                </div>
                              </div>
                            </div>
                  ...
                  <div className="space-y-4">
                    <div className="flex justify-between items-center">
                      <span className="text-gray-600">
                        Base Fare ({formValues.passengers.length} passenger{formValues.passengers.length > 1 ? "s" : ""}
                        )
                      </span>
                      ...
                      <div className="flex justify-between items-center">
                        ...
                        <span className="font-medium">
                          ...
                          {formValues.passengers
                            .reduce((sum, p) => sum + p.checkedBaggage * PRICES.CHECKED_BAGGAGE, 0)
                            .toFixed(2)}
                        </span>
                      </div>
                    )}
                    ...
                    {formValues.passengers.some((p) => p.cabinBaggage > 0) && (
                      <div className="flex justify-between items-center">
                        ...
                        <span className="font-medium">
                          $
                          {formValues.passengers
                            .reduce((sum, p) => sum + p.cabinBaggage * PRICES.CABIN_BAGGAGE, 0)
                            .toFixed(2)}
                        </span>
                      </div>
                    )}
                    ...
                    {formValues.passengers.some((p) => p.insurance) && (
                      <div className="flex justify-between items-center">
                        ...
                        <span className="font-medium">
                          $
                          {formValues.passengers
                            .reduce((sum, p) => sum + (p.insurance ? PRICES.INSURANCE : 0), 0)
                            .toFixed(2)}
                        </span>
                      </div>
                    )}
                    ...
                    <div className="flex justify-between items-center pt-2">
                      ...
                      <span className="text-lg font-bold text-indigo-900">${totalPrice.toFixed(2)}</span>
                    </div>
                    ...
                    <Button
                      className="w-full mt-6 bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-700 hover:to-purple-700 text-white"
                    >
                      {isSubmitting ? (
                        <>
