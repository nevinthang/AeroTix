      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div 
          ...
          style={{
            top: '10%',
            right: '0%',
            transform: `translate(40%, -40%) rotate(${scrollPosition * 0.1}deg)`
          }}
        />
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="text-center mb-16 relative">
            <div className="relative inline-block">
              <h1 className="text-6xl md:text-8xl font-bold mb-6 text-gray-900">
                ...
                <span className="relative mx-4">
                  ...
                  <svg className="absolute -bottom-4 left-0 w-full" height="10" viewBox="0 0 100 10">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Your journey to extraordinary destinations begins with a single search
            </p>
          </div>
