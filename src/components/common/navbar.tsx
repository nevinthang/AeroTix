            ...
            <div className="hidden md:flex items-center space-x-8">
              ...
              {isLoggedIn ? (
                ...
                <div
                  ...
                  className="relative overflow-hidden bg-gradient-to-r from-purple-600 to-blue-600 text-white px-6 py-2.5 rounded-full text-sm font-medium transition-all duration-300 hover:shadow-glow group cursor-pointer"
                >
            ...
            >
              {isLoggedIn ? (
                ...
                <div
                  ...
                  className="block w-full text-center bg-gradient-to-r from-purple-600 to-blue-600 text-white px-4 py-3 rounded-lg text-sm font-medium transition-all duration-300 hover:shadow-glow cursor-pointer"
                >
                  Login
                </div>
